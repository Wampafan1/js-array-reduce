...
function extractValue(arr, key) {
    return arr.reduce((peoplesNames, currentName) => {
        peoplesNames.push(currentName[key])
        return peoplesNames
    },[])
...
function vowelCount(str) {
    ...
    return arr.reduce((accumulator, currentLetter) =>{
        if(vowels.includes(currentLetter)){
            if(accumulator[currentLetter] == null){
